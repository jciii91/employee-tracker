    ...
    inquirer.prompt([
        {
            ...
            choices: ['View all departments','View all roles','View all employees','Add a department','Add a role','Add an employee','Update an employee role','Close this application'],
        },
    ])
    .then(answers => {
